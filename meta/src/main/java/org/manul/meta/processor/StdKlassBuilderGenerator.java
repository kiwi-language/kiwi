...
class StdKlassBuilderGenerator extends AbstractGenerator {
    ...
    private void generateBuild() {
        ...
        var isApi = clazz.getQualifiedName().toString().startsWith("org.manul.api.");
            ...
            switch (member) {
                case VariableElement field -> {
                    if (member.getModifiers().contains(Modifier.STATIC)) {
                      if (field.asType() instanceof DeclaredType dt && isClassType(dt, "org.manul.entity.IndexDef"))
                ...
                case ExecutableElement method -> {
                    if ((isApi || isAnnotatedWith(method, "org.manul.api.EntityFlow"))
    ...
    private void generateKlassBuild() {
        ...
        generateGetModelId("org.manul.object.type.Klass", getModelName(clazz));
        ...
        var entityAt = findAnnotation(clazz, "org.manul.api.Entity");
        if (entityAt != null) {
    ...
    private boolean isEntity(TypeMirror type) {
        return type instanceof DeclaredType dt && isAnnotatedWith(dt.asElement(), "org.manul.api.Entity");
    }
    ...
    private void generateIndexBuild(VariableElement field) {
        ...
        generateGetModelId("org.manul.object.type.Index", getModelName(field));
    ...
    private void generateFieldBuild(VariableElement field) {
        ...
        indent();
        write(".id(");
        generateGetModelId("org.manul.object.type.Field", getModelName(field));
        writeln(")");
        writeln(".build();");
        deIndent();
    }
    ...
    private void generateMethodBuild(ExecutableElement method) {
        ...
        indent();
        write(".id(");
        generateGetModelId("org.manul.flow.Method", getModelName(method));
        writeln(")");
    ...
    private void generateParameterBuild(VariableElement parameter) {
        write("new Parameter(");
        generateGetModelId("org.manul.flow.Parameter", getModelName(parameter));
    ...
    private void generateTypeVariableBuild(TypeParameterElement typeParam) {
        ...
        generateGetModelId("org.manul.object.type.TypeVariable", getModelName(typeParam));
        ...
        return switch (type.getKind()) {
            ...
            case DECLARED -> {
                ...
                if (qualName.contentEquals("java.lang.Object"))
                    ...
                    yield "time";
                else if (qualName.contentEquals("org.manul.object.type.Klass"))
                    yield "org.manul.object.type.Klass";
    ...
    private void writeImports() {
        writeImport("org.manul.entity.StdKlassBuilder");
        writeImport("org.manul.object.type.KlassBuilder");
        writeImport("org.manul.object.type.Klass");
        writeImport("org.manul.object.type.FieldBuilder");
        writeImport("org.manul.flow.MethodBuilder");
        writeImport("org.manul.entity.StdKlassRegistry");
        writeImport("org.manul.entity.ModelIdentity");
        writeImport("org.manul.object.type.Types");
        writeImport("org.manul.util.ParameterizedTypeImpl");
        writeImport("org.manul.flow.NameAndType");
        writeImport("org.manul.entity.DummyGenericDeclaration");
        writeImport("org.manul.object.type.TypeVariable");
        writeImport("org.manul.util.Utils");
        writeImport("org.manul.flow.Parameter");
        writeImport("org.manul.object.type.Index");
        writeImport("org.manul.object.type.ClassType");
        writeImport("org.manul.object.type.ResolutionStage");
        writeImport("org.manul.object.type.ClassKind");
        writeImport("org.manul.object.type.ClassSource");
        writeImport("org.manul.object.instance.core.Id");
