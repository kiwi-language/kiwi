...
public class InstanceContextTest extends TestCase {
    ...
    public void testSmoking() {
        ...
        Assert.assertFalse(DiffUtils.isPojoDifferent(PersistenceUtils.toInstancePO(instance, APP_ID), PersistenceUtils.toInstancePO(loadedInstance, APP_ID)));
    }
    ...
    public void testReplace2() {
        ...
        Assert.assertFalse(DiffUtils.isPojoDifferent(PersistenceUtils.toInstancePO(loaded, APP_ID),
                PersistenceUtils.toInstancePO(instance, APP_ID)));
    ...
    public void testIndex() {
        ...
        MatcherAssert.assertThat(PersistenceUtils.toInstancePO(fooInstance, APP_ID), PojoMatcher.of(PersistenceUtils.toInstancePO(selectedInstances.get(0), APP_ID)));
    }
    ...
    public void testArray() {
        ...
        Assert.assertFalse(DiffUtils.isPojoDifferent(PersistenceUtils.toInstancePO(bazInst, APP_ID), bazInstancePO));
        ...
        MatcherAssert.assertThat(PersistenceUtils.toInstancePO(bazInst.getInstanceField(bazBarsField), APP_ID), PojoMatcher.of(barsArrayPO));
        ...
        MatcherAssert.assertThat(PersistenceUtils.toInstancePO(bazInst, APP_ID), PojoMatcher.of(PersistenceUtils.toInstancePO(loadedBazInst, APP_ID)));
        MatcherAssert.assertThat(PersistenceUtils.toInstancePO(bazInst.getInstanceField(bazBarsField), APP_ID), PojoMatcher.of(PersistenceUtils.toInstancePO(barsArray, APP_ID)));
    }
    ...
    private void assertPersisted(Instance instance) {
        ...
        Assert.assertFalse(DiffUtils.isPojoDifferent(PersistenceUtils.toInstancePO(instance, APP_ID), po));
    }
