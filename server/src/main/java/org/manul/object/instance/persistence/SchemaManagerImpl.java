    ...
    public void switchTable(long appId, boolean backup) {
        ...
        try (var stmt = connection.createStatement()) {
            ...
            if (backup) {
                ...
                stmt.addBatch(
                        String.format("alter index index_entry_%d_instance_id_idx rename to index_entry_bak_%d_instance_id_idx", appId, appId)
                );
            } else {
            ...
            stmt.addBatch(
                    String.format("alter index index_entry_tmp_%d_instance_id_idx rename to index_entry_%d_instance_id_idx", appId, appId)
            );
            stmt.executeBatch();
