...
//            statement.execute("drop table if exists reference");
//            statement.execute(SQLStatements.CREATE_REFERENCE);
//        }
...
//        ReferenceMapper referenceMapper = session.getMapper(ReferenceMapper.class);
//
//        InstanceMapperGateway instanceMapperGateway = new InstanceMapperGateway(instanceMapper, instanceArrayMapper);
//        instanceStore = new InstanceStore(instanceMapperGateway, indexEntryMapper, referenceMapper);
//
//        checkConstraintPlugin = new CheckConstraintPlugin();
//        indexConstraintPlugin = new IndexConstraintPlugin(indexEntryMapper);
