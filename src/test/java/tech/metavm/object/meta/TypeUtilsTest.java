...
public class TypeUtilsTest extends TestCase {
    ...
    public void testGetCommonSuperTypes() {
        ...
        var c3 = ClassBuilder.newBuilder("c3", null)
                .superClass(c1).build();
        Assert.assertSame(c1, TypeUtils.getLeastUpperBound(List.of(c1, c2, c3)));
        Assert.assertSame(c1, TypeUtils.getLeastUpperBound(List.of(c2, c3)));
    }
    ...
    public void testGetCommonSuperTypes_union() {
        ...
        var cst = TypeUtils.getLeastUpperBound(List.of(c1, u1));
    ...
    public void testGetCommonSuperTypes_intersection() {
        ...
        var cst = TypeUtils.getLeastUpperBound(List.of(c1, intersect));
        Assert.assertSame(c1, cst);
    }
    ...
    public void testGetCommonSuperTypes_interface() {
        ...
        var c3 = ClassBuilder.newBuilder("c3", null)
                .interfaces(c1).build();
        var cst = TypeUtils.getLeastUpperBound(List.of(c2, c3));
        Assert.assertSame(c1, cst);
    }
    ...
    public void testGetCommonSuperTypes_nullable() {
        ...
        var cst = TypeUtils.getLeastUpperBound(List.of(c2, nullable_c3));
