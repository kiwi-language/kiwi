...
public class SubstitutorV2Test extends TestCase {
    ...
    public void test() {
                ...
                .build();
        {
            ...
            returnNode.setValue(new ExpressionValue(new NodeExpression(valueNode)));
        }

        {
            ...
            updateNode.setObjectId(new ReferenceValue(new NodeExpression(selfNode)));
            updateNode.setUpdateField(
                    valueField, UpdateOp.SET,
                    new ReferenceValue(new PropertyExpression(new NodeExpression(inputNode), inputValueField))
            );
