...
//import java.util.*;
//
//import static tech.metavm.entity.LoadingOption.*;
//
//@Component
...
//
//        context.loadForeignKey(
//                ForeignKeyDef.FIELD_DECLARING_TYPE,
//                request.idsWithoutOption(FIELDS_LAZY_LOADING)
//        );
//
//        context.loadForeignKey(
//                ForeignKeyDef.CONSTRAINT_DECLARING_TYPE,
//                request.idsWithoutOption(CONSTRAINTS_LAZY_LOADING)
//        );
//
//        context.loadForeignKey(
//                ForeignKeyDef.ENUM_CONSTANT_TYPE,
//                request.idsWithFilter(item ->
//                        item.isOptionAbsent(ENUM_CONSTANTS_LAZY_LOADING) && isEnum(typePOMap.get(item.id()))
//                )
//        );
//
//        return NncUtils.map(
//                typePOs,
//                typePO -> new EntitySupplier(typePO.getId(), () -> new Type(typePO, context))
//        );
//    }
//
...
//    }
//
//    public Type getByCategory(TypeCategory category, InstanceContext context) {
//        TypePO typePO = typeMapper.selectByCode(category.code());
//        return createFromPO(typePO, context, LoadingOption.none());
//    }
//
//    public Type getByName(String name, InstanceContext context) {
//        TypePO typePO = typeMapper.selectByName(context.getTenantId(), name);
//        return createFromPO(typePO, context, LoadingOption.none());
//    }
//
//    private Type createFromPO(TypePO typePO, InstanceContext context, Set<LoadingOption> options) {
//        if(typePO == null) {
//            return null;
//        }
...
//    }
//
//    private List<Type> createFromPOs(List<TypePO> typePOs, InstanceContext context, Set<LoadingOption> options) {
//        context.preload(
//                Type.class,
//                EntitySupplier.fromList(
//                        typePOs,
//                        typePO -> () -> new Type(typePO, context)
//                )
//        );
//        return context.batchGet(Type.class, NncUtils.map(typePOs, TypePO::getId));
//    }
//
...
////        return new LoadingList<>(() -> fieldStore.getByDeclaringTypeIds(List.of(type.getId()), type.getContext()));
////    }
//
...
//    }
//
//    public List<Type> query(TypeQuery query, InstanceContext context) {
...
////        fieldStore.preloadByDeclaringTypeIds(NncUtils.map(types, Entity::getId), context);
//        return types;
//    }
//
//    private boolean isEnum(TypePO typePO) {
//        return typePO != null && TypeCategory.getByCodeRequired(typePO.getCategory()).isEnum();
//    }
//
//    public List<Type> batchGet(Collection<Long> ids, InstanceContext context, Set<LoadingOption> options) {
//        if(NncUtils.isEmpty(ids)) {
//            return List.of();
//        }
//        context.load(Type.class, ids, options);
//        return context.batchGet(Type.class, ids);
//
////        List<TypePO> typePOs = NncUtils.splitAndMerge(
////                ids,
////                StdTypeManager::isStandardTypeId,
