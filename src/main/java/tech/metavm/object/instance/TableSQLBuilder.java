...
public class TableSQLBuilder {
    ...
    public void addColumn(String name, ColumnType type, boolean notNull, Object defaultValue, String comment) {
        addColumn(name, type, notNull, defaultValue, comment, false, false);
    }

    public void addColumn(String name, ColumnType type, boolean notNull, Object defaultValue,
