...
//
//@Component
//public class InstanceMapperBak {
//
//    public static final Logger LOGGER = LoggerFactory.getLogger(InstanceMapperBak.class);
//
...
//
//    public InstanceMapperBak(DataSource dataSource) {
...
//                stmt.setObject(index++, convertToColumnValue(column, record.get(column)));
//            }
...
//                );
//                for (String column : SQLColumnType.sqlColumnNames()) {
//                    record.put(column, convertToFieldValue(column, resultSet.getObject(column)));
//                }
//                records.add(record);
//            }
//            return records;
...
//
//
//    private Object convertToColumnValue(String columnName, Object fieldValue) {
//        if(fieldValue == null) {
//            return null;
//        }
//        if(columnName.startsWith("o")) {
//            return NncUtils.toJSONString(fieldValue);
//        }
//        return fieldValue;
//    }
//
//    private Object convertToFieldValue(String columnName, Object columnValue) {
//        if(columnValue == null) {
//            return null;
//        }
//        if(columnName.startsWith("o")) {
//            return NncUtils.readJSONString((String) columnValue, InstancePO.class);
//        }
//        return columnValue;
//    }
//
