...
//        List<ScopePO> scopePOs = scopeMapper.batchSelect(request.ids());
//        return EntitySupplier.fromList(
//                scopePOs,
//                scopePO -> () -> new ScopeRT(scopePO, context)
//        );
//    }
//
//    public List<ScopeRT> batchGet(Collection<Long> ids, InstanceContext context, Set<LoadingOption> options) {
...
//        List<ScopePO> scopePOs = scopeMapper.selectByFlowIds(flowIds);
//        context.preload(
//                ScopeRT.class,
//                EntitySupplier.fromList(scopePOs, scopePO -> () -> new ScopeRT(scopePO, context))
//        );
//        return NncUtils.toMultiMap(scopePOs, ScopePO::getFlowId, ScopePO::getId);
//    }
//
//    @Override
