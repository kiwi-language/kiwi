package tech.metavm.object.instance.persistence.mappers;//package tech.metavm.object.instance.persistence.mappers;
//
...
//            );
//
//            List<InstancePO> instancePOs = instanceMapper.selectByIds(APP_ID, List.of(instancePO.getId()));
...
//            instancePOs = instanceMapper.selectByIds(APP_ID, List.of(instancePO.getId()));
...
//
//            instanceMapper.batchDelete(APP_ID, System.currentTimeMillis(), List.of(instancePO.nextVersion()));
//            instancePOs = instanceMapper.selectByIds(APP_ID, List.of(instancePO.getId()));
