...
public class UtilsTest extends TestCase {
    ...
    public void testToBase64() {
        System.out.println(Utils.encodeBase64(1000000000));
    }
    ...
    public void testRandomPassword() {
        System.out.println(Utils.randomPassword());
    }

    public void testTryParseLong() {
        Assert.assertEquals((Object) 111L, Utils.tryParseLong("000111"));
        Assert.assertEquals((Object) (-1L), Utils.tryParseLong("-1"));
        Assert.assertNull(Utils.tryParseLong("abc"));
    }
