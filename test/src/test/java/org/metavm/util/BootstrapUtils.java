    ...
    public static BootstrapResult bootstrap() {
        ...
        if (state != null) {
            ...
            entityContextFactory.setInstanceLogService(
                    new InstanceLogServiceImpl(entityContextFactory, mapperRegistry, new MockTransactionOperations(), metaContextCache)
            );
...
//        var instanceStore = new MemInstanceStore(mapperRegistry);
