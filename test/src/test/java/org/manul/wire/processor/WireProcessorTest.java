...
public class WireProcessorTest extends TestCase {
    ...
    public void test() throws Exception {
        var source = JavaFileObjects.forSourceString(
                "org.manul.wire.mock.Foo",
                """
                package org.manul.wire.mock;
        ...
        var content = assertThat(c).generatedFile(StandardLocation.CLASS_OUTPUT, "META-INF/services/org.manul.wire.WireAdapter")
                .contentsAsUtf8String();
        content.contains("org.manul.wire.mock.Foo$__WireAdapter__");
        content.contains("org.manul.wire.mock.Base$__WireAdapter__");
        content.contains("org.manul.wire.mock.Bar$__WireAdapter__");
        content.contains("org.manul.wire.mock.BazAdapter");
    }
