...
//    private static final String host = "https://api.manul.tech/object";
...
//    public static final String yuanCurrencyId = "01d8a8d6b90700";
    ...
    private static void prepare() {
        defaultProductKindId = get("/org/manul/mlab/ProductKind/DEFAULT");
        yuanCurrencyId = get("/org/manul/mlab/Currency/YUAN");
        dollarCurrencyId = get("/org/manul/mlab/Currency/DOLLAR");
        couponActiveStateId = get("/org/manul/mlab/CouponState/ACTIVE");
...
//        getProductName(productId);
    ...
    private static String createProduct() {
        return put("/org/manul/mlab/Product", Map.of(
                "name", "Shoes",
    ...
    private static String createCoupon(String code, double amount, String currency) {
        return put("/org/manul/mlab/Coupon", Map.of(
                "code", code,
