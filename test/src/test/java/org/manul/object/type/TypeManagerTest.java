...
public class TypeManagerTest extends TestCase {
    ...
    public void testShopping() {
        MockUtils.assemble("manul/shopping.mnl", typeManager, schedulerAndWorker);
...
//        TestUtils.waitForTaskDone(t -> t instanceof SynchronizeSearchTask, entityContextFactory);
    ...
    public void testDeployWithAppId() {
        ...
        TestUtils.doInTransaction(() ->
            typeManager.deploy(APP_ID, false, MockUtils.compile("manul/simple_shopping.mnl"))
        );
    ...
    public void testChangeStaticFields() {
        MockUtils.assemble("manul/static_fields.mnl", typeManager, schedulerAndWorker);
...
//    }
    ...
    public void testEntityRefcount() {
        MockUtils.assemble("manul/del/del.mnl", typeManager, schedulerAndWorker);
        TestUtils.doInTransactionWithoutResult(() -> {
            try (var context = entityContextFactory.newContext(APP_ID)) {
    ...
    public void testAppStatusCheck() {
        ...
        try {
            MockUtils.assemble("manul/foo.mnl", typeManager, schedulerAndWorker);
