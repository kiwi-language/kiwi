...
import org.manul.entity.ModelIdentity;
...
public class StdAllocatorsTest extends TestCase {
    ...
    public void testSmoking() {
        var klassNameField = ModelIdentity.create(Field.class, "org.manul.object.type.Klass.name");
    ...
    public void testGetTypeId() {
        var klassNameReflectField = ModelIdentity.create(Field.class, "org.manul.object.type.Klass.name");
