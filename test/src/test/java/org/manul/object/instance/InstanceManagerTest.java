...
import org.manul.mocks.FooState;
import org.manul.mocks.IndexFoo;
...
public class InstanceManagerTest extends TestCase {
    ...
    public void testUtils() {
        MockUtils.assemble("manul/util/Utils.mnl", typeManager, schedulerAndWorker);
    ...
    public void testGenericOverloading() {
        MockUtils.assemble("manul/GenericOverloading.mnl", typeManager, schedulerAndWorker);
    ...
    public void testLambda() {
        MockUtils.assemble("manul/Lambda.mnl", typeManager, schedulerAndWorker);
