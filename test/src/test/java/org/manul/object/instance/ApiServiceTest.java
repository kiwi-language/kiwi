...
import static org.manul.util.ApiClient.KEY_DOLLAR_ID;
...
public class ApiServiceTest extends TestCase {
    ...
    public void testSummary() {
        MockUtils.assemble("manul/summary/summary.mnl", typeManager, schedulerAndWorker);
    ...
    public void testSearchWithCreatedId() {
        MockUtils.assemble("manul/search/search.mnl", typeManager, schedulerAndWorker);
