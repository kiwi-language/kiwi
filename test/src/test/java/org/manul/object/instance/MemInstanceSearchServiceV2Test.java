...
import org.manul.object.instance.search.AndSearchCondition;
import org.manul.object.instance.search.MatchSearchCondition;
...
public class MemInstanceSearchServiceV2Test extends TestCase {
    ...
    public void test() {
        ...
        assertEquals(Objects.requireNonNull(foo.tryGetId()), result.items().getFirst());
    }
    ...
    public void testSearchingSuperClassField() {
        ...
        assertEquals(1, result.total());
        assertEquals(Objects.requireNonNull(human.tryGetId()), result.items().getFirst());
