...
public class MetaProcessorTest extends TestCase {
    ...
    public void test() {
        ...
        var c = Compiler.javac()
                ...
                .compile(JavaFileObjects.forSourceString("org.manul.api.Dummy", source));

        assertThat(c).succeeded();

        assertThat(c).generatedSourceFile("org.manul.api.Dummy__KlassBuilder__");
        var file = c.generatedSourceFile("org.manul.api.Dummy__KlassBuilder__").orElseThrow();
        System.out.println(file.getCharContent(true));
        assertThat(c).generatedFile(StandardLocation.CLASS_OUTPUT, "META-INF/services/org.manul.entity.StdKlassBuilder")
                .contentsAsUtf8String().contains("org.manul.api.Dummy__KlassBuilder__");
    }
