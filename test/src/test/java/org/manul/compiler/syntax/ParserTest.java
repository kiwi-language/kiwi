...
import org.manul.compiler.syntax.Parser.LtResult;
...
import static org.manul.compiler.syntax.Parser.ParensResult.LAMBDA;
import static org.manul.compiler.syntax.Parser.ParensResult.PARENS;
...
public class ParserTest extends TestCase {
    ...
    public void testIntegrated() throws URISyntaxException, IOException {
        var path = Paths.get(requireNonNull(ParserTest.class.getResource("/manul/shopping.mnl")).toURI());
    ...
    public void testError1() {
        ...
        assertEquals(
                """
                        dummy.mnl:2: Unexpected token: final
                            final class Product {}
                            ^""",
                diag.toString()
        );
