...
public class NamingUtilsTest extends TestCase {
    ...
    public void testPathToName() {
        ...
        {
            var path = "org/manul/lab/user-service";
            var name = NamingUtils.pathToName(path);
            Assert.assertEquals("org.manul.lab.UserService", name);
        }
    }

    public void testNameToPath() {
        var name = "org.manul.lab.UserService";
        var path = NamingUtils.nameToPath(name);
        Assert.assertEquals("org/manul/lab/user-service", path);
    }
