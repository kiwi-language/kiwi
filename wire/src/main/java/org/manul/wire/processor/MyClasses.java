...
class MyClasses {
    ...
    public MyClasses(Elements elements) {
        ...
        wireInput = resolver.forName("org.manul.wire.WireInput");
        wireOutput = resolver.forName("org.manul.wire.WireOutput");
        wireVisitor = resolver.forName("org.manul.wire.WireVisitor");
        wireAdapter = resolver.forName("org.manul.wire.WireAdapter");
        adapterRegistry = resolver.forName("org.manul.wire.AdapterRegistry");
        wire = resolver.forName("org.manul.wire.Wire");
        parent = resolver.forName("org.manul.wire.Parent");
        enumCode = resolver.forName("org.manul.entity.EnumCode");
        enumFromCode = resolver.forName("org.manul.entity.EnumFromCode");
        unsupportedOperationException = resolver.forName("java.lang.UnsupportedOperationException");
        wireIOException = resolver.forName("org.manul.wire.WireIOException");
