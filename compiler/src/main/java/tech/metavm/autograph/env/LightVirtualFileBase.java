...
public abstract class LightVirtualFileBase extends VirtualFile {
    ...
    public static final class MyVirtualFileSystem extends DeprecatedVirtualFileSystem implements NonPhysicalFileSystem {
        private static final @NonNls String PROTOCOL = "mock";

        private final Map<String, VirtualFile> path2file = new ConcurrentHashMap<>();

        public MyVirtualFileSystem() {
    ...
    public static final MyVirtualFileSystem ourFileSystem = new MyVirtualFileSystem();
