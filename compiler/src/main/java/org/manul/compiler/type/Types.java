...
import org.manul.compiler.analyze.ResolveKind;
import org.manul.compiler.diag.Errors;
import org.manul.compiler.element.Package;
import org.manul.compiler.element.*;
import org.manul.compiler.syntax.Expr;
import org.manul.compiler.syntax.Ident;
import org.manul.compiler.syntax.SelectorExpr;
import org.manul.compiler.syntax.TypeApply;
...
import static org.manul.compiler.generate.WireTypes.STRING_TYPE;
...
public class Types {
    ...
    private Clazz createStringClass() {
        ...
        new Param("that", clazz, compareTo);
