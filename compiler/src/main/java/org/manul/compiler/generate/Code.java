...
import org.manul.compiler.util.Buffer;
import org.manul.compiler.util.List;
import org.manul.compiler.util.Traces;

import javax.annotation.Nullable;
import java.util.Arrays;

import static org.manul.compiler.generate.Bytecodes.*;
...
//        lastCode = code;
    ...
    public class State {
        ...
        public void join(State that) {
            if (top != that.top)
                throw new IllegalStateException("top not equal. current top: " + top + ", joined top: " + that.top);
            for (int i = 0; i < top; i++) {
                var type1 = stack[i];
