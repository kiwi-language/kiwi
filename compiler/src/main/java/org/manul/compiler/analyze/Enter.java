...
import static org.manul.compiler.util.Traces.traceEntering;
...
public class Enter {
    ...
    private class EnterVisitor extends StructuralNodeVisitor {
        ...
        public Void visitClassDecl(ClassDecl classDecl) {
            ...
            if (mods.static_ || classDecl.tag() == org.manul.compiler.syntax.ClassTag.ENUM
                    || classDecl.tag() == org.manul.compiler.syntax.ClassTag.VALUE)
