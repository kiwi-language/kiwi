...
import org.manul.compiler.analyze.Enter;
...
public class MockEnter {
    ...
    private static Clazz createIndex(Package rootPkg) {
        var pkg = rootPkg.subPackage("org").subPackage("manul").subPackage("api");
    ...
    private static void createInterceptor(Project project) {
        var reqCls = project.getClass("org.manul.api.entity.HttpRequest");
        var respCls = project.getClass("org.manul.api.entity.HttpResponse");
        var pkg = project.getPackage("org.manul.api");
    ...
    private static void createHttpRequest(Project project) {
        var pkg = project.getPackage("org.manul.api.entity");
    ...
    private static void createHttpResponse(Project project) {
        var pkg = project.getPackage("org.manul.api.entity");
        var cookieCls = project.getClass("org.manul.api.entity.HttpCookie");
        var headerCls = project.getClass("org.manul.api.entity.HttpHeader");
