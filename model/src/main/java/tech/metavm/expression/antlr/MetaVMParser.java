...
public class MetaVMParser extends Parser {
	...
	public static final int
		ALL_MATCH=1, AS=2, THIS=3, INSTANCEOF=4, DECIMAL_LITERAL=5, HEX_LITERAL=6, 
		OCT_LITERAL=7, BINARY_LITERAL=8, FLOAT_LITERAL=9, HEX_FLOAT_LITERAL=10, 
		BOOL_LITERAL=11, SINGLE_QUOTED_STRING_LITERAL=12, STRING_LITERAL=13, TEXT_BLOCK=14, 
		NULL_LITERAL=15, LPAREN=16, RPAREN=17, LBRACE=18, RBRACE=19, LBRACK=20, 
		RBRACK=21, SEMI=22, COMMA=23, DOT=24, EQUAL=25, GT=26, LT=27, BANG=28, 
		TILDE=29, QUESTION=30, COLON=31, LE=32, GE=33, NOTEQUAL=34, AND=35, OR=36, 
		INC=37, DEC=38, ADD=39, SUB=40, MUL=41, DIV=42, BITAND=43, BITOR=44, CARET=45, 
		MOD=46, ARROW=47, COLONCOLON=48, AT=49, ELLIPSIS=50, WS=51, COMMENT=52, 
		LINE_COMMENT=53, IDENTIFIER=54, SUPER=55, CLASS=56, NEW=57, FINAL=58, 
		MODULE=59, OPEN=60, REQUIRES=61, EXPORTS=62, OPENS=63, TO=64, USES=65, 
		PROVIDES=66, WITH=67, TRANSITIVE=68, YIELD=69, SEALED=70, PERMITS=71, 
		RECORD=72, VAR=73, VOID=74, EXTENDS=75, BOOLEAN=76, CHAR=77, BYTE=78, 
		SHORT=79, INT=80, LONG=81, FLOAT=82, DOUBLE=83;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'allmatch'", "'as'", "'this'", "'instanceof'", null, null, null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ALL_MATCH", "AS", "THIS", "INSTANCEOF", "DECIMAL_LITERAL", "HEX_LITERAL", 
			"OCT_LITERAL", "BINARY_LITERAL", "FLOAT_LITERAL", "HEX_FLOAT_LITERAL", 
			"BOOL_LITERAL", "SINGLE_QUOTED_STRING_LITERAL", "STRING_LITERAL", "TEXT_BLOCK", 
			"NULL_LITERAL", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", 
			"SEMI", "COMMA", "DOT", "EQUAL", "GT", "LT", "BANG", "TILDE", "QUESTION", 
			"COLON", "LE", "GE", "NOTEQUAL", "AND", "OR", "INC", "DEC", "ADD", "SUB", 
			"MUL", "DIV", "BITAND", "BITOR", "CARET", "MOD", "ARROW", "COLONCOLON", 
			"AT", "ELLIPSIS", "WS", "COMMENT", "LINE_COMMENT", "IDENTIFIER", "SUPER", 
			"CLASS", "NEW", "FINAL", "MODULE", "OPEN", "REQUIRES", "EXPORTS", "OPENS", 
			"TO", "USES", "PROVIDES", "WITH", "TRANSITIVE", "YIELD", "SEALED", "PERMITS", 
			"RECORD", "VAR", "VOID", "EXTENDS", "BOOLEAN", "CHAR", "BYTE", "SHORT", 
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -377737356220694550L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 1046527L) != 0)) {
				{
				setState(225);
				expressionList();
				}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -377737356220432406L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 1046527L) != 0)) {
				{
				setState(307);
				variableInitializer();
				setState(312);
	...
	public static class LiteralContext extends ParserRuleContext {
		...
		public TerminalNode SINGLE_QUOTED_STRING_LITERAL() { return getToken(MetaVMParser.SINGLE_QUOTED_STRING_LITERAL, 0); }
	...
	public final IdentifierContext identifier() throws RecognitionException {
		...
		try {
			...
			setState(430);
			_la = _input.LA(1);
			if ( !(((((_la - 54)) & ~0x3f) == 0 && ((1L << (_la - 54)) & 1048545L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TypeIdentifierContext typeIdentifier() throws RecognitionException {
		...
		try {
			...
			setState(432);
			_la = _input.LA(1);
			if ( !(((((_la - 54)) & ~0x3f) == 0 && ((1L << (_la - 54)) & 491489L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AltAnnotationQualifiedNameContext altAnnotationQualifiedName() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 54)) & ~0x3f) == 0 && ((1L << (_la - 54)) & 1048545L) != 0)) {
				{
				{
				setState(463);
				identifier();
	...
	public static class TypeArgumentContext extends ParserRuleContext {
		...
		public TerminalNode EXTENDS() { return getToken(MetaVMParser.EXTENDS, 0); }
		public TerminalNode SUPER() { return getToken(MetaVMParser.SUPER, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MetaVMParserListener ) ((MetaVMParserListener)listener).enterTypeArgument(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public final TypeArgumentContext typeArgument() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((((_la - 49)) & ~0x3f) == 0 && ((1L << (_la - 49)) & 33553441L) != 0)) {
					{
					{
					setState(488);
					annotation();
	...
	public static class PrimitiveTypeContext extends ParserRuleContext {
		...
		public TerminalNode BYTE() { return getToken(MetaVMParser.BYTE, 0); }
		public TerminalNode SHORT() { return getToken(MetaVMParser.SHORT, 0); }
		public TerminalNode INT() { return getToken(MetaVMParser.INT, 0); }
		public TerminalNode LONG() { return getToken(MetaVMParser.LONG, 0); }
		public TerminalNode FLOAT() { return getToken(MetaVMParser.FLOAT, 0); }
