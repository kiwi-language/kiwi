...
public class AssemblyParser extends Parser {
	...
	public static final int
		...
		INSTANCEOF=23, INT=24, INTERFACE=25, NATIVE=26, NEW=27, NEW_UNBOUND=28, 
		NEW_EPHEMERAL=29, PRIVATE=30, PROTECTED=31, PUBLIC=32, RETURN=33, STATIC=34, 
		SUPER=35, SWITCH=36, THIS=37, THROW=38, THROWS=39, TRY=40, VOID=41, WHILE=42, 
		...
		COMMA=84, DOT=85, ARROW=86, COLONCOLON=87, AT=88, ELLIPSIS=89, DECIMAL_LITERAL=90, 
		HEX_LITERAL=91, OCT_LITERAL=92, BINARY_LITERAL=93, FLOAT_LITERAL=94, HEX_FLOAT_LITERAL=95, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'interface'", "'native'", "'new'", "'new_unbound'", "'new_ephemeral'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INT", "INTERFACE", "NATIVE", "NEW", "NEW_UNBOUND", "NEW_EPHEMERAL", 
			"PRIVATE", "PROTECTED", "PUBLIC", "RETURN", "STATIC", "SUPER", "SWITCH", 
			"THIS", "THROW", "THROWS", "TRY", "VOID", "WHILE", "ASSIGN", "GT", "LT", 
			...
			"STRING_LITERAL", "TEXT_BLOCK", "R", "RW", "C", "IDENTIFIER", "WS", "COMMENT", 
			"LINE_COMMENT"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1081081039285126144L) != 0) || ((((_la - 77)) & ~0x3f) == 0 && ((1L << (_la - 77)) & 75489345L) != 0)) {
				{
				{
				setState(399);
				labeledStatement();
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public TerminalNode NEW_UNBOUND() { return getToken(AssemblyParser.NEW_UNBOUND, 0); }
		public TerminalNode NEW_EPHEMERAL() { return getToken(AssemblyParser.NEW_EPHEMERAL, 0); }
