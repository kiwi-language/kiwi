...
public class LambdaFrame extends MetaFrame {
    ...
    public LambdaFrame(NodeRT entry, ClassType declaringType,
                       List<Instance> arguments, InstanceRepository instanceRepository, ParameterizedFlowProvider parameterizedFlowProvider, MetaFrame containingFrame) {
        super(entry, declaringType, containingFrame.getSelf(), arguments, instanceRepository, parameterizedFlowProvider);
