...
public class Dup2Node extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public Dup2Node(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, null, previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new Dup2Node(name, input.getPrev(), input.getCode());
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitDupNode2(this);
    }
