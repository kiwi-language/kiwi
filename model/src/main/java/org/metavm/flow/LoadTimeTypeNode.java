...
public class LoadTimeTypeNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LoadTimeTypeNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, StdKlass.primitiveType.type(), previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new LoadTimeTypeNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LT_TIME);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLoadTimeTypeNode(this);
    }
