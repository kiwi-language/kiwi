...
public class DoubleNegNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public DoubleNegNode(String name,
    ...
    public static Node read(CodeInput input, String name) {
        return new DoubleNegNode(name, input.getPrev(), input.getCode());
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitDoubleNegNode(this);
    }
