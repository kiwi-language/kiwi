...
public class LongShiftRightNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LongShiftRightNode(String name,
    ...
    public static Node read(CodeInput input, String name) {
        return new LongShiftRightNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LONG_SHIFT_RIGHT);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLongShiftRightNode(this);
    }
