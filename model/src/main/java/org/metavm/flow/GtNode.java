...
import org.metavm.flow.rest.GtNodeParam;
...
public class GtNode extends NodeRT {
    ...
    public static GtNode save(NodeDTO nodeDTO, NodeRT prev, ScopeRT scope, NodeSavingStage stage, IEntityContext context) {
        ...
        if (node == null) {
            GtNodeParam param = nodeDTO.getParam();
            ...
            node = new GtNode(nodeDTO.tmpId(), nodeDTO.name(), nodeDTO.code(),
    ...
    protected Object getParam(SerializeContext serializeContext) {
        return new GtNodeParam(first.toDTO(), second.toDTO());
    }
