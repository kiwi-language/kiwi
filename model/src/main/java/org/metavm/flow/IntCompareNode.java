...
public class IntCompareNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public IntCompareNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, null, previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new IntCompareNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.INT_COMPARE);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitIntCompareNode(this);
    }
