...
import org.metavm.flow.rest.DivideNodeParam;
...
public class DivideNode extends NodeRT {
    ...
    public static DivideNode save(NodeDTO nodeDTO, NodeRT prev, ScopeRT scope, NodeSavingStage stage, IEntityContext context) {
        ...
        if (node == null) {
            DivideNodeParam param = nodeDTO.getParam();
            ...
            node = new DivideNode(nodeDTO.tmpId(), nodeDTO.name(), nodeDTO.code(),
    ...
    protected Object getParam(SerializeContext serializeContext) {
        return new DivideNodeParam(first.toDTO(), second.toDTO());
    }
