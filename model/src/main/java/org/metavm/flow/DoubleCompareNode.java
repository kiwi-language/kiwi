...
public class DoubleCompareNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public DoubleCompareNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, null, previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new DoubleCompareNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.DOUBLE_COMPARE);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitDoubleCompareNode(this);
    }
