...
public class LoadReturnTypeNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LoadReturnTypeNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, StdKlass.type.type(), previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new LoadReturnTypeNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LT_RETURN);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLoadReturnTypeNode(this);
    }
