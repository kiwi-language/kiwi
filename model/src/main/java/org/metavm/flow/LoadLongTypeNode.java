...
public class LoadLongTypeNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LoadLongTypeNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, StdKlass.primitiveType.type(), previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new LoadLongTypeNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LT_LONG);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLoadLongTypeNode(this);
    }
