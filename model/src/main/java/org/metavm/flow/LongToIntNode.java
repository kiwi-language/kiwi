...
public class LongToIntNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LongToIntNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, null, previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new LongToIntNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LONG_TO_INT);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLongToIntNode(this);
    }
