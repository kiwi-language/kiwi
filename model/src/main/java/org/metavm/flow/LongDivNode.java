...
public class LongDivNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LongDivNode(String name,
    ...
    public static Node read(CodeInput input, String name) {
        return new LongDivNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LONG_DIV);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLongDivNode(this);
    }
