...
import org.metavm.flow.rest.GeNodeParam;
...
public class GeNode extends NodeRT {
    ...
    public static GeNode save(NodeDTO nodeDTO, NodeRT prev, ScopeRT scope, NodeSavingStage stage, IEntityContext context) {
        ...
        if (node == null) {
            GeNodeParam param = nodeDTO.getParam();
            ...
            node = new GeNode(nodeDTO.tmpId(), nodeDTO.name(), nodeDTO.code(),
    ...
    protected Object getParam(SerializeContext serializeContext) {
        return new GeNodeParam(first.toDTO(), second.toDTO());
    }
