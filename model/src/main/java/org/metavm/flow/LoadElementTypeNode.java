...
public class LoadElementTypeNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LoadElementTypeNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, StdKlass.type.type(), previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new LoadElementTypeNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LT_ELEMENT);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLoadElementTypeNode(this);
    }
