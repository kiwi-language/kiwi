...
public class DoubleDivNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public DoubleDivNode(String name,
    ...
    public static Node read(CodeInput input, String name) {
        return new DoubleDivNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.DOUBLE_DIV);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitDoubleDivNode(this);
    }
