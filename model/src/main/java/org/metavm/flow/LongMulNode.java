...
public class LongMulNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LongMulNode(String name,
    ...
    public static Node read(CodeInput input, String name) {
        return new LongMulNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LONG_MUL);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLongMulNode(this);
    }
