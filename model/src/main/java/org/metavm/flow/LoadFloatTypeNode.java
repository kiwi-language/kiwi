...
public class LoadFloatTypeNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LoadFloatTypeNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, StdKlass.primitiveType.type(), previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new LoadFloatTypeNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.LT_FLOAT);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLoadFloatTypeNode(this);
    }
