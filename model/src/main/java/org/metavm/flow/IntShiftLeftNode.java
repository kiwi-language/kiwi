...
public class IntShiftLeftNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public IntShiftLeftNode(String name,
    ...
    public static Node read(CodeInput input, String name) {
        return new IntShiftLeftNode(name, input.getPrev(), input.getCode());
    }
    ...
    public void writeCode(CodeOutput output) {
        output.write(Bytecodes.INT_SHIFT_LEFT);
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitIntShiftLeftNode(this);
    }
