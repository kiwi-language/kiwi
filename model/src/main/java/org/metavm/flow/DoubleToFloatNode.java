...
public class DoubleToFloatNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public DoubleToFloatNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, null, previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new DoubleToFloatNode(name, input.getPrev(), input.getCode());
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitDoubleToFloat(this);
    }
