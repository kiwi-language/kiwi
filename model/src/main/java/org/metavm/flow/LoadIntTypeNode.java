...
public class LoadIntTypeNode extends Node {

    @SuppressWarnings("unused")
    private static Klass __klass__;

    public LoadIntTypeNode(@NotNull String name, @Nullable Node previous, @NotNull Code code) {
        super(name, StdKlass.primitiveType.type(), previous, code);
    }

    public static Node read(CodeInput input, String name) {
        return new LoadIntTypeNode(name, input.getPrev(), input.getCode());
    }
    ...
    public <R> R accept(ElementVisitor<R> visitor) {
        return visitor.visitLoadIntTypeNode(this);
    }
