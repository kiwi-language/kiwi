...
public enum NodeKind {
    ...
    MUL(NodeKindCodes.MUL, MultiplyNode.class, Void.class),
    DIV(NodeKindCodes.DIV, DivideNode.class, Void.class),
    ...
    BITWISE_OR(NodeKindCodes.BITWISE_OR, BitwiseOrNode.class, Void.class),
    BITWISE_AND(NodeKindCodes.BITWISE_AND, BitwiseAndNode.class, Void.class),
    BITWISE_XOR(NodeKindCodes.BITWISE_XOR, BitwiseXorNode.class, Void.class),
    AND(NodeKindCodes.AND, AndNode.class, Void.class),
    OR(NodeKindCodes.OR, OrNode.class, Void.class),
    BITWISE_COMPLEMENT(NodeKindCodes.BITWISE_COMPLEMENT, BitwiseComplementNode.class, Void.class),
