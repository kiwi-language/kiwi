...
public class AssemblyParser extends Parser {
	...
	public static final int
		...
		RECORD=8, STRUCT=9, TIME=10, NULL=11, PASSWORD=12, DOUBLE=13, ELSE=14, 
		ENUM=15, EXTENDS=16, READONLY=17, CHILD=18, TITLE=19, FINALLY=20, FOR=21, 
		IF=22, IMPLEMENTS=23, INSTANCEOF=24, INT=25, INTERFACE=26, NATIVE=27, 
		ENEW=28, UNEW=29, NEW=30, PRIVATE=31, PROTECTED=32, PUBLIC=33, RETURN=34, 
		STATIC=35, SUPER=36, SWITCH=37, THIS=38, THROW=39, THROWS=40, TRY=41, 
		VOID=42, WHILE=43, ANY=44, NEVER=45, ASSIGN=46, GT=47, LT=48, BANG=49, 
		TILDE=50, QUESTION=51, COLON=52, EQUAL=53, LE=54, GE=55, NOTEQUAL=56, 
		AND=57, OR=58, INC=59, DEC=60, ADD=61, SUB=62, MUL=63, DIV=64, BITAND=65, 
		BITOR=66, CARET=67, MOD=68, ADD_ASSIGN=69, SUB_ASSIGN=70, MUL_ASSIGN=71, 
		DIV_ASSIGN=72, AND_ASSIGN=73, OR_ASSIGN=74, XOR_ASSIGN=75, MOD_ASSIGN=76, 
		LSHIFT_ASSIGN=77, RSHIFT_ASSIGN=78, URSHIFT_ASSIGN=79, LPAREN=80, RPAREN=81, 
		LBRACE=82, RBRACE=83, LBRACK=84, RBRACK=85, SEMI=86, COMMA=87, DOT=88, 
		ARROW=89, COLONCOLON=90, AT=91, ELLIPSIS=92, DECIMAL_LITERAL=93, HEX_LITERAL=94, 
		OCT_LITERAL=95, BINARY_LITERAL=96, FLOAT_LITERAL=97, HEX_FLOAT_LITERAL=98, 
		BOOL_LITERAL=99, CHAR_LITERAL=100, STRING_LITERAL=101, TEXT_BLOCK=102, 
		R=103, RW=104, C=105, V=106, IDENTIFIER=107, WS=108, COMMENT=109, LINE_COMMENT=110;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'class'", "'record'", "'struct'", "'time'", "'null'", "'password'", 
			"'double'", "'else'", "'enum'", "'extends'", "'readonly'", "'child'", 
			"'title'", "'finally'", "'for'", "'if'", "'implements'", "'instanceof'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RECORD", "STRUCT", "TIME", "NULL", "PASSWORD", "DOUBLE", "ELSE", "ENUM", 
			"EXTENDS", "READONLY", "CHILD", "TITLE", "FINALLY", "FOR", "IF", "IMPLEMENTS", 
			"INSTANCEOF", "INT", "INTERFACE", "NATIVE", "ENEW", "UNEW", "NEW", "PRIVATE", 
			"PROTECTED", "PUBLIC", "RETURN", "STATIC", "SUPER", "SWITCH", "THIS", 
			"THROW", "THROWS", "TRY", "VOID", "WHILE", "ANY", "NEVER", "ASSIGN", 
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 49459266434L) != 0) || _la==SEMI );
			}
		}
	...
	public final TypeDeclarationContext typeDeclaration() throws RecognitionException {
		...
		try {
			...
			case STATIC:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 49392123906L) != 0)) {
					{
					{
					setState(157);
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 338699142184006L) != 0) || ((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & 134217745L) != 0)) {
				{
				{
				setState(187);
	...
	public final ClassBodyDeclarationContext classBodyDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 49527259138L) != 0)) {
				{
				{
				setState(203);
				modifier();
	...
	public final InterfaceBodyContext interfaceBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 338699142184022L) != 0) || ((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & 134217809L) != 0)) {
				{
				{
				setState(260);
	...
	public final InterfaceMethodDeclarationContext interfaceMethodDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 42949672978L) != 0)) {
				{
				{
				setState(280);
	...
	public final InterfaceMethodModifierContext interfaceMethodModifier() throws RecognitionException {
		...
		try {
			...
			setState(291);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 42949672978L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final FormalParametersContext formalParameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 57174638214212L) != 0) || ((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & 134217745L) != 0)) {
				{
				setState(370);
				formalParameterList();
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8648612179385255936L) != 0) || ((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & 142598209L) != 0)) {
				{
				{
				setState(401);
				labeledStatement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8648600409289525248L) != 0) || ((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & 142598145L) != 0)) {
					{
					setState(446);
					expression(0);
					}
			...
			case 12:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 46)) & ~0x3f) == 0 && ((1L << (_la - 46)) & 17171480577L) != 0)) ) {
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8648600409289525248L) != 0) || ((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & 142598149L) != 0)) {
				{
				setState(533);
				variableInitializer();
				setState(538);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & 35L) != 0)) ) {
	...
	public final PrimitiveTypeContext primitiveType() throws RecognitionException {
		...
		try {
			...
			setState(856);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 4398080080964L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ClassOrInterfaceModifierContext classOrInterfaceModifier() throws RecognitionException {
		...
		try {
			...
			setState(865);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 49392123906L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static final String _serializedATN =
		...
		"\u0001C\u0001D\u0001D\u0003D\u034c\bD\u0001E\u0001E\u0001E\u0001E\u0005"+
		"E\u0352\bE\nE\fE\u0355\tE\u0001E\u0001E\u0001F\u0001F\u0001G\u0001G\u0001"+
		"G\u0001G\u0001G\u0003G\u0360\bG\u0001H\u0001H\u0001I\u0001I\u0001I\u0001"+
		"I\u0001I\u0001I\u0001J\u0001J\u0003J\u036c\bJ\u0001J\u0001J\u0001K\u0001"+
		"K\u0001K\u0000\u0002j\u0084L\u0000\u0002\u0004\u0006\b\n\f\u000e\u0010"+
		"\u0012\u0014\u0016\u0018\u001a\u001c\u001e \"$&(*,.02468:<>@BDFHJLNPR"+
		"TVXZ\\^`bdfhjlnprtvxz|~\u0080\u0082\u0084\u0086\u0088\u008a\u008c\u008e"+
		"\u0090\u0092\u0094\u0096\u0000\u0011\u0001\u0000\u0007\t\u0004\u0000\u0001"+
