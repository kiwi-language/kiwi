...
public class AssemblyParser extends Parser {
	...
	public static final int
		...
		SELECT=52, SELECT_FIRST=53, DELETED=54, VAR=55, ASSIGN=56, GT=57, LT=58, 
		BANG=59, BANGBANG=60, TILDE=61, QUESTION=62, COLON=63, EQUAL=64, LE=65, 
		GE=66, NOTEQUAL=67, AND=68, OR=69, INC=70, DEC=71, ADD=72, SUB=73, MUL=74, 
		DIV=75, BITAND=76, BITOR=77, CARET=78, MOD=79, ADD_ASSIGN=80, SUB_ASSIGN=81, 
		MUL_ASSIGN=82, DIV_ASSIGN=83, AND_ASSIGN=84, OR_ASSIGN=85, XOR_ASSIGN=86, 
		MOD_ASSIGN=87, LSHIFT_ASSIGN=88, RSHIFT_ASSIGN=89, URSHIFT_ASSIGN=90, 
		LPAREN=91, RPAREN=92, LBRACE=93, RBRACE=94, LBRACK=95, RBRACK=96, SEMI=97, 
		COMMA=98, DOT=99, ARROW=100, COLONCOLON=101, AT=102, ELLIPSIS=103, DECIMAL_LITERAL=104, 
		HEX_LITERAL=105, OCT_LITERAL=106, BINARY_LITERAL=107, FLOAT_LITERAL=108, 
		HEX_FLOAT_LITERAL=109, BOOL_LITERAL=110, CHAR_LITERAL=111, STRING_LITERAL=112, 
		TEXT_BLOCK=113, R=114, RW=115, C=116, V=117, IDENTIFIER=118, WS=119, COMMENT=120, 
		LINE_COMMENT=121;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'<<='", "'>>='", "'>>>='", "'('", "')'", "'{'", "'}'", "'['", "']'", 
			"';'", "','", "'.'", "'->'", "'::'", "'@'", "'...'", null, null, null, 
			null, null, null, null, null, null, null, "'[r]'", "'[rw]'", "'[c]'", 
			"'[v]'"
		};
	}
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 309907116374832710L) != 0) || ((((_la - 91)) & ~0x3f) == 0 && ((1L << (_la - 91)) & 134217745L) != 0)) {
				{
				{
				setState(228);
	...
	public final InterfaceBodyContext interfaceBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 309907116374832214L) != 0) || ((((_la - 91)) & ~0x3f) == 0 && ((1L << (_la - 91)) & 134217809L) != 0)) {
				{
				{
				setState(318);
	...
	public final FormalParametersContext formalParameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3659176308060228L) != 0) || ((((_la - 91)) & ~0x3f) == 0 && ((1L << (_la - 91)) & 134217745L) != 0)) {
				{
				setState(429);
				formalParameterList();
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2936273420327006276L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 299050152755215L) != 0)) {
				{
				{
				setState(460);
				statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2895836679480811520L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 299049984983055L) != 0)) {
					{
					setState(499);
					expression(0);
					}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2895836679480811520L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 299049993371663L) != 0)) {
				{
				setState(624);
				variableInitializer();
				setState(629);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 12:
						...
						((ExpressionContext)_localctx).bop = _input.LT(1);
						_la = _input.LA(1);
						if ( !(((((_la - 56)) & ~0x3f) == 0 && ((1L << (_la - 56)) & 34342961153L) != 0)) ) {
							((ExpressionContext)_localctx).bop = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
