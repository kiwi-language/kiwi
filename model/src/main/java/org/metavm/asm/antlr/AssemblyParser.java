...
public class AssemblyParser extends Parser {
	...
	public static final int
		...
		INT=29, LONG=30, CHAR=31, INTERFACE=32, NATIVE=33, ENEW=34, UNEW=35, NEW=36, 
		ALLOCATE=37, PRIVATE=38, PROTECTED=39, PUBLIC=40, RETURN=41, STATIC=42, 
		SUPER=43, SWITCH=44, THIS=45, THROW=46, THROWS=47, TRY=48, VOID=49, WHILE=50, 
		ANY=51, NEVER=52, SELECT=53, SELECT_FIRST=54, DELETED=55, VAR=56, ASSIGN=57, 
		GT=58, LT=59, BANG=60, BANGBANG=61, TILDE=62, QUESTION=63, COLON=64, EQUAL=65, 
		LE=66, GE=67, NOTEQUAL=68, AND=69, OR=70, INC=71, DEC=72, ADD=73, SUB=74, 
		MUL=75, DIV=76, BITAND=77, BITOR=78, CARET=79, MOD=80, ADD_ASSIGN=81, 
		SUB_ASSIGN=82, MUL_ASSIGN=83, DIV_ASSIGN=84, AND_ASSIGN=85, OR_ASSIGN=86, 
		XOR_ASSIGN=87, MOD_ASSIGN=88, LSHIFT_ASSIGN=89, RSHIFT_ASSIGN=90, URSHIFT_ASSIGN=91, 
		LPAREN=92, RPAREN=93, LBRACE=94, RBRACE=95, LBRACK=96, RBRACK=97, SEMI=98, 
		COMMA=99, DOT=100, ARROW=101, COLONCOLON=102, AT=103, ELLIPSIS=104, DECIMAL_LITERAL=105, 
		HEX_LITERAL=106, OCT_LITERAL=107, BINARY_LITERAL=108, FLOAT_LITERAL=109, 
		HEX_FLOAT_LITERAL=110, BOOL_LITERAL=111, CHAR_LITERAL=112, STRING_LITERAL=113, 
		TEXT_BLOCK=114, R=115, RW=116, C=117, V=118, IDENTIFIER=119, WS=120, COMMENT=121, 
		LINE_COMMENT=122;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'if'", "'implements'", "'instanceof'", "'int'", "'long'", "'char'", 
			"'interface'", "'native'", "'enew'", "'unew'", "'new'", "'allocate'", 
			"'private'", "'protected'", "'public'", "'return'", "'static'", "'super'", 
			"'switch'", "'this'", "'throw'", "'throws'", "'try'", "'void'", "'while'", 
			"'any'", "'never'", "'select'", "'selectFirst'", "'deleted'", "'var'", 
			"'='", "'>'", "'<'", "'!'", "'!!'", "'~'", "'?'", "':'", "'=='", "'<='", 
			"'>='", "'!='", "'&&'", "'||'", "'++'", "'--'", "'+'", "'-'", "'*'", 
			"'/'", "'&'", "'|'", "'^'", "'%'", "'+='", "'-='", "'*='", "'/='", "'&='", 
			"'|='", "'^='", "'%='", "'<<='", "'>>='", "'>>>='", "'('", "')'", "'{'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TITLE", "FINALLY", "FOR", "IF", "IMPLEMENTS", "INSTANCEOF", "INT", "LONG", 
			"CHAR", "INTERFACE", "NATIVE", "ENEW", "UNEW", "NEW", "ALLOCATE", "PRIVATE", 
			"PROTECTED", "PUBLIC", "RETURN", "STATIC", "SUPER", "SWITCH", "THIS", 
			"THROW", "THROWS", "TRY", "VOID", "WHILE", "ANY", "NEVER", "SELECT", 
			"SELECT_FIRST", "DELETED", "VAR", "ASSIGN", "GT", "LT", "BANG", "BANGBANG", 
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 6326487353730L) != 0) || _la==SEMI || _la==AT );
			}
		}
	...
	public final TypeDeclarationContext typeDeclaration() throws RecognitionException {
		...
		try {
			...
			case AT:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6322191859714L) != 0)) {
					{
					{
					setState(192);
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 619814233271645766L) != 0) || ((((_la - 92)) & ~0x3f) == 0 && ((1L << (_la - 92)) & 134217745L) != 0)) {
				{
				{
				setState(228);
	...
	public final ClassBodyDeclarationContext classBodyDeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 36035127815439362L) != 0)) {
					{
					{
					setState(244);
					modifier();
	...
	public final InterfaceBodyContext interfaceBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 619814233271645270L) != 0) || ((((_la - 92)) & ~0x3f) == 0 && ((1L << (_la - 92)) & 134217809L) != 0)) {
				{
				{
				setState(318);
	...
	public final InterfaceMethodDeclarationContext interfaceMethodDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 5497558138898L) != 0)) {
				{
				{
				setState(338);
	...
	public final InterfaceMethodModifierContext interfaceMethodModifier() throws RecognitionException {
		...
		try {
			...
			setState(349);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 5497558138898L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final FormalParametersContext formalParameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 7318353152782404L) != 0) || ((((_la - 92)) & ~0x3f) == 0 && ((1L << (_la - 92)) & 134217745L) != 0)) {
				{
				setState(429);
				formalParameterList();
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 5872546841090011204L) != 0) || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 299050152755215L) != 0)) {
				{
				{
				setState(460);
				statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 5791673358961614848L) != 0) || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 299049984983055L) != 0)) {
					{
					setState(499);
					expression(0);
					}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 5791673358961614848L) != 0) || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 299049993371663L) != 0)) {
				{
				setState(624);
				variableInitializer();
				setState(629);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						((ExpressionContext)_localctx).bop = _input.LT(1);
						_la = _input.LA(1);
						if ( !(((((_la - 58)) & ~0x3f) == 0 && ((1L << (_la - 58)) & 771L) != 0)) ) {
							((ExpressionContext)_localctx).bop = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					...
					case 12:
						...
						((ExpressionContext)_localctx).bop = _input.LT(1);
						_la = _input.LA(1);
						if ( !(((((_la - 57)) & ~0x3f) == 0 && ((1L << (_la - 57)) & 34342961153L) != 0)) ) {
							((ExpressionContext)_localctx).bop = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					...
					case 15:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 61)) & ~0x3f) == 0 && ((1L << (_la - 61)) & 3073L) != 0)) ) {
	...
	public final PrimitiveTypeContext primitiveType() throws RecognitionException {
		...
		try {
			...
			setState(949);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 562953711726660L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ClassOrInterfaceModifierContext classOrInterfaceModifier() throws RecognitionException {
		...
		try {
			...
			setState(960);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 6322191859714L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
