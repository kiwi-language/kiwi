...
public class MetaVMParser extends Parser {
	...
	public static final int
		...
		DOUBLE=9, STRING=10, PASSWORD=11, TIME=12, VOID=13, CLASS=14, R=15, C=16, 
		...
		SUPER=68, NEW=69, FINAL=70, MODULE=71, OPEN=72, REQUIRES=73, EXPORTS=74, 
		OPENS=75, TO=76, USES=77, PROVIDES=78, WITH=79, TRANSITIVE=80, YIELD=81, 
		SEALED=82, PERMITS=83, RECORD=84, VAR=85;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'void'", "'class'", "'[r]'", "'[c]'", "'[v]'", null, null, null, null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LONG", "DOUBLE", "STRING", "PASSWORD", "TIME", "VOID", "CLASS", "R", 
			"C", "V", "DECIMAL_LITERAL", "HEX_LITERAL", "OCT_LITERAL", "BINARY_LITERAL", 
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16896204847464426L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 524279L) != 0)) {
				{
				setState(227);
				expressionList();
				}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16896206994948074L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 524279L) != 0)) {
				{
				setState(309);
				variableInitializer();
				setState(314);
	...
	public final ElementValueArrayInitializerContext elementValueArrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4628582225422335978L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 524279L) != 0)) {
				{
				setState(404);
				elementValue();
				setState(409);
	...
	public final IdentifierContext identifier() throws RecognitionException {
		...
		try {
			...
			setState(432);
			_la = _input.LA(1);
			if ( !(((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 524273L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TypeIdentifierContext typeIdentifier() throws RecognitionException {
		...
		try {
			...
			setState(434);
			_la = _input.LA(1);
			if ( !(((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 245745L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AltAnnotationQualifiedNameContext altAnnotationQualifiedName() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 524273L) != 0)) {
				{
				{
				setState(465);
				identifier();
	...
	private TypeTypeContext typeType(int _p) throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9395257312L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 524273L) != 0)) {
					{
					setState(516);
					typeList();
					}
	...
	public final PrimitiveTypeContext primitiveType() throws RecognitionException {
		...
		try {
			...
			setState(557);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 268451712L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
