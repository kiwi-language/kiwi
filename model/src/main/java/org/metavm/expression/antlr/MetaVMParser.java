...
public class MetaVMParser extends Parser {
	...
	public static final int
		...
		DOUBLE=9, STRING=10, PASSWORD=11, TIME=12, VOID=13, CLASS=14, R=15, RW=16, 
		C=17, V=18, DECIMAL_LITERAL=19, HEX_LITERAL=20, OCT_LITERAL=21, BINARY_LITERAL=22, 
		FLOAT_LITERAL=23, HEX_FLOAT_LITERAL=24, BOOL_LITERAL=25, SINGLE_QUOTED_STRING_LITERAL=26, 
		STRING_LITERAL=27, TEXT_BLOCK=28, NULL_LITERAL=29, LPAREN=30, RPAREN=31, 
		LBRACE=32, RBRACE=33, LBRACK=34, RBRACK=35, SEMI=36, COMMA=37, DOT=38, 
		EQUAL=39, GT=40, LT=41, BANG=42, TILDE=43, QUESTION=44, COLON=45, LE=46, 
		GE=47, NOTEQUAL=48, AND=49, OR=50, INC=51, DEC=52, ADD=53, SUB=54, MUL=55, 
		DIV=56, BITAND=57, BITOR=58, CARET=59, MOD=60, ARROW=61, COLONCOLON=62, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RW", "C", "V", "DECIMAL_LITERAL", "HEX_LITERAL", "OCT_LITERAL", "BINARY_LITERAL", 
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 33792409694912490L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 524279L) != 0)) {
				{
				setState(225);
				expressionList();
				}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 33792413989879786L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 524279L) != 0)) {
				{
				setState(307);
				variableInitializer();
				setState(312);
	...
	public final ElementValueArrayInitializerContext elementValueArrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -9189579622864896022L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 524279L) != 0)) {
				{
				setState(402);
				elementValue();
				setState(407);
	...
	private TypeTypeContext typeType(int _p) throws RecognitionException {
		...
		try {
			...
			case LPAREN:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 18253627360L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 524273L) != 0)) {
					{
					setState(513);
					typeList();
					}
