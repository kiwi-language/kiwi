...
public class MetaVMParser extends Parser {
	...
	public static final int
		...
		INT=9, CHAR=10, DOUBLE=11, STRING=12, PASSWORD=13, TIME=14, VOID=15, CLASS=16, 
		R=17, C=18, V=19, DECIMAL_LITERAL=20, HEX_LITERAL=21, OCT_LITERAL=22, 
		BINARY_LITERAL=23, FLOAT_LITERAL=24, HEX_FLOAT_LITERAL=25, BOOL_LITERAL=26, 
		CHAR_LITERAL=27, STRING_LITERAL=28, TEXT_BLOCK=29, NULL_LITERAL=30, LPAREN=31, 
		RPAREN=32, LBRACE=33, RBRACE=34, LBRACK=35, RBRACK=36, SEMI=37, COMMA=38, 
		DOT=39, EQUAL=40, GT=41, LT=42, BANG=43, TILDE=44, QUESTION=45, COLON=46, 
		LE=47, GE=48, NOTEQUAL=49, AND=50, OR=51, INC=52, DEC=53, ADD=54, SUB=55, 
		MUL=56, DIV=57, BITAND=58, BITOR=59, CARET=60, MOD=61, ARROW=62, COLONCOLON=63, 
		AT=64, ELLIPSIS=65, WS=66, COMMENT=67, LINE_COMMENT=68, IDENTIFIER=69, 
		SUPER=70, NEW=71, FINAL=72, MODULE=73, OPEN=74, REQUIRES=75, EXPORTS=76, 
		OPENS=77, TO=78, USES=79, PROVIDES=80, WITH=81, TRANSITIVE=82, YIELD=83, 
		SEALED=84, PERMITS=85, RECORD=86, VAR=87;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'boolean'", "'long'", "'int'", "'char'", "'dobule'", "'string'", "'password'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LONG", "INT", "CHAR", "DOUBLE", "STRING", "PASSWORD", "TIME", "VOID", 
			"CLASS", "R", "C", "V", "DECIMAL_LITERAL", "HEX_LITERAL", "OCT_LITERAL", 
			...
			"EQUAL", "GT", "LT", "BANG", "TILDE", "QUESTION", "COLON", "LE", "GE", 
			"NOTEQUAL", "AND", "OR", "INC", "DEC", "ADD", "SUB", "MUL", "DIV", "BITAND", 
			"BITOR", "CARET", "MOD", "ARROW", "COLONCOLON", "AT", "ELLIPSIS", "WS", 
			"COMMENT", "LINE_COMMENT", "IDENTIFIER", "SUPER", "NEW", "FINAL", "MODULE", 
			"OPEN", "REQUIRES", "EXPORTS", "OPENS", "TO", "USES", "PROVIDES", "WITH", 
			"TRANSITIVE", "YIELD", "SEALED", "PERMITS", "RECORD", "VAR"
		};
	}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 2522015791327477760L) != 0)) ) {
					...
					case 4:
						...
						((ExpressionContext)_localctx).bop = _input.LT(1);
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 428809534832640L) != 0)) ) {
							((ExpressionContext)_localctx).bop = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 67584819389857770L) != 0) || ((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 524279L) != 0)) {
				{
				setState(227);
				expressionList();
				}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 67584827979792362L) != 0) || ((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 524279L) != 0)) {
				{
				setState(309);
				variableInitializer();
				setState(314);
	...
	public final ElementValueArrayInitializerContext elementValueArrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 67584827979792362L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 16776929L) != 0)) {
				{
				setState(404);
				elementValue();
				setState(409);
	...
	public final IdentifierContext identifier() throws RecognitionException {
		...
		try {
			...
			setState(433);
			_la = _input.LA(1);
			if ( !(((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 524273L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TypeIdentifierContext typeIdentifier() throws RecognitionException {
		...
		try {
			...
			setState(435);
			_la = _input.LA(1);
			if ( !(((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 245745L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AltAnnotationQualifiedNameContext altAnnotationQualifiedName() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 524273L) != 0)) {
				{
				{
				setState(466);
				identifier();
	...
	private TypeTypeContext typeType(int _p) throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 37581029344L) != 0) || ((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 524273L) != 0)) {
					{
					setState(521);
					typeList();
					}
	...
	public final PrimitiveTypeContext primitiveType() throws RecognitionException {
		...
		try {
			...
			setState(562);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1073807232L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
