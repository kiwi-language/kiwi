...
public class MetaVMParser extends Parser {
	...
	public static final int
		...
		DOUBLE=9, STRING=10, PASSWORD=11, TIME=12, VOID=13, R=14, RW=15, C=16, 
		V=17, DECIMAL_LITERAL=18, HEX_LITERAL=19, OCT_LITERAL=20, BINARY_LITERAL=21, 
		FLOAT_LITERAL=22, HEX_FLOAT_LITERAL=23, BOOL_LITERAL=24, SINGLE_QUOTED_STRING_LITERAL=25, 
		STRING_LITERAL=26, TEXT_BLOCK=27, NULL_LITERAL=28, LPAREN=29, RPAREN=30, 
		LBRACE=31, RBRACE=32, LBRACK=33, RBRACK=34, SEMI=35, COMMA=36, DOT=37, 
		EQUAL=38, GT=39, LT=40, BANG=41, TILDE=42, QUESTION=43, COLON=44, LE=45, 
		GE=46, NOTEQUAL=47, AND=48, OR=49, INC=50, DEC=51, ADD=52, SUB=53, MUL=54, 
		DIV=55, BITAND=56, BITOR=57, CARET=58, MOD=59, ARROW=60, COLONCOLON=61, 
		AT=62, ELLIPSIS=63, WS=64, COMMENT=65, LINE_COMMENT=66, IDENTIFIER=67, 
		SUPER=68, CLASS=69, NEW=70, FINAL=71, MODULE=72, OPEN=73, REQUIRES=74, 
		EXPORTS=75, OPENS=76, TO=77, USES=78, PROVIDES=79, WITH=80, TRANSITIVE=81, 
		YIELD=82, SEALED=83, PERMITS=84, RECORD=85, VAR=86;
	public static final int
		...
		RULE_classOrInterfaceType = 35, RULE_typeType = 36, RULE_arrayKind = 37, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"classOrInterfaceType", "typeType", "arrayKind", "primitiveType", "nonWildcardTypeArguments", 
			"typeList"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'boolean'", "'long'", "'dobule'", "'string'", "'password'", "'time'", 
			"'void'", "'[r]'", "'[rw]'", "'[c]'", "'[v]'", null, null, null, null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LONG", "DOUBLE", "STRING", "PASSWORD", "TIME", "VOID", "R", "RW", "C", 
			"V", "DECIMAL_LITERAL", "HEX_LITERAL", "OCT_LITERAL", "BINARY_LITERAL", 
			"FLOAT_LITERAL", "HEX_FLOAT_LITERAL", "BOOL_LITERAL", "SINGLE_QUOTED_STRING_LITERAL", 
			...
			"IDENTIFIER", "SUPER", "CLASS", "NEW", "FINAL", "MODULE", "OPEN", "REQUIRES", 
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16896204847464426L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 1048555L) != 0)) {
				{
				setState(225);
				expressionList();
				}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16896206994948074L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 1048555L) != 0)) {
				{
				setState(307);
				variableInitializer();
				setState(312);
	...
	public final ElementValueArrayInitializerContext elementValueArrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4628582225422335978L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 1048555L) != 0)) {
				{
				setState(402);
				elementValue();
				setState(407);
	...
	public final IdentifierContext identifier() throws RecognitionException {
		...
		try {
			...
			setState(430);
			_la = _input.LA(1);
			if ( !(((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 1048545L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TypeIdentifierContext typeIdentifier() throws RecognitionException {
		...
		try {
			...
			setState(432);
			_la = _input.LA(1);
			if ( !(((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 491489L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AltAnnotationQualifiedNameContext altAnnotationQualifiedName() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 1048545L) != 0)) {
				{
				{
				setState(463);
				identifier();
	...
	private TypeTypeContext typeType(int _p) throws RecognitionException {
		...
		try {
			...
			case LPAREN:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9126821856L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 1048545L) != 0)) {
					{
					setState(513);
					typeList();
					}
	...
	public static class ArrayKindContext extends ParserRuleContext {
		...
		public TerminalNode RW() { return getToken(MetaVMParser.RW, 0); }
	...
	public final ArrayKindContext arrayKind() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_arrayKind);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
