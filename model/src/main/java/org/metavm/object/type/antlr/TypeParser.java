...
public class TypeParser extends Parser {
	...
	public static final int
		BOOLEAN=1, DOUBLE=2, LONG=3, INT=4, CHAR=5, VOID=6, NULL=7, TIME=8, PASSWORD=9, 
		STRING=10, ANY=11, NEVER=12, R=13, C=14, V=15, FUNC=16, LPAREN=17, RPAREN=18, 
		LBRACK=19, RBRACK=20, COMMA=21, DOT=22, NUM=23, COLON=24, AT=25, GT=26, 
		LT=27, BITAND=28, BITOR=29, QUESTION=30, ARROW=31, COLONCOLON=32, WS=33, 
		IDENTIFIER=34, DECIMAL_LITERAL=35;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'boolean'", "'double'", "'long'", "'int'", "'char'", "'void'", 
			"'null'", "'time'", "'password'", "'string'", "'any'", "'never'", "'[r]'", 
			"'[c]'", "'[v]'", "'func'", "'('", "')'", "'['", "']'", "','", "'.'", 
			"'#'", "':'", "'@'", "'>'", "'<'", "'&'", "'|'", "'?'", "'->'", "'::'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "BOOLEAN", "DOUBLE", "LONG", "INT", "CHAR", "VOID", "NULL", "TIME", 
			"PASSWORD", "STRING", "ANY", "NEVER", "R", "C", "V", "FUNC", "LPAREN", 
			"RPAREN", "LBRACK", "RBRACK", "COMMA", "DOT", "NUM", "COLON", "AT", "GT", 
			"LT", "BITAND", "BITOR", "QUESTION", "ARROW", "COLONCOLON", "WS", "IDENTIFIER", 
			"DECIMAL_LITERAL"
		};
	}
	...
	private TypeContext type(int _p) throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17222475774L) != 0)) {
					{
					setState(57);
					typeList();
					}
