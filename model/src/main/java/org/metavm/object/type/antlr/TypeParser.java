...
public class TypeParser extends Parser {
	...
	public static final int
		BOOLEAN=1, DOUBLE=2, FLOAT=3, LONG=4, INT=5, CHAR=6, VOID=7, NULL=8, TIME=9, 
		PASSWORD=10, STRING=11, ANY=12, NEVER=13, R=14, C=15, V=16, FUNC=17, LPAREN=18, 
		RPAREN=19, LBRACK=20, RBRACK=21, COMMA=22, DOT=23, NUM=24, COLON=25, AT=26, 
		GT=27, LT=28, BITAND=29, BITOR=30, QUESTION=31, ARROW=32, COLONCOLON=33, 
		WS=34, IDENTIFIER=35, DECIMAL_LITERAL=36;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'void'", "'null'", "'time'", "'password'", "'string'", "'any'", "'never'", 
			"'[r]'", "'[c]'", "'[v]'", "'func'", "'('", "')'", "'['", "']'", "','", 
			"'.'", "'#'", "':'", "'@'", "'>'", "'<'", "'&'", "'|'", "'?'", "'->'", 
			"'::'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "BOOLEAN", "DOUBLE", "FLOAT", "LONG", "INT", "CHAR", "VOID", "NULL", 
			"TIME", "PASSWORD", "STRING", "ANY", "NEVER", "R", "C", "V", "FUNC", 
			"LPAREN", "RPAREN", "LBRACK", "RBRACK", "COMMA", "DOT", "NUM", "COLON", 
			"AT", "GT", "LT", "BITAND", "BITOR", "QUESTION", "ARROW", "COLONCOLON", 
			"WS", "IDENTIFIER", "DECIMAL_LITERAL"
		};
	}
	...
	private TypeContext type(int _p) throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 34444951550L) != 0)) {
					{
					setState(57);
					typeList();
					}
