...
public class TypeParser extends Parser {
	...
	public static final int
		BOOLEAN=1, DOUBLE=2, FLOAT=3, LONG=4, INT=5, CHAR=6, SHORT=7, BYTE=8, 
		VOID=9, NULL=10, TIME=11, PASSWORD=12, STRING=13, ANY=14, NEVER=15, R=16, 
		C=17, V=18, FUNC=19, LPAREN=20, RPAREN=21, LBRACK=22, RBRACK=23, COMMA=24, 
		DOT=25, NUM=26, COLON=27, AT=28, GT=29, LT=30, BITAND=31, BITOR=32, QUESTION=33, 
		ARROW=34, COLONCOLON=35, WS=36, IDENTIFIER=37, DECIMAL_LITERAL=38;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'boolean'", "'double'", "'float'", "'long'", "'int'", "'char'", 
			"'short'", "'byte'", "'void'", "'null'", "'time'", "'password'", "'string'", 
			"'any'", "'never'", "'[r]'", "'[c]'", "'[v]'", "'func'", "'('", "')'", 
			"'['", "']'", "','", "'.'", "'#'", "':'", "'@'", "'>'", "'<'", "'&'", 
			"'|'", "'?'", "'->'", "'::'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "BOOLEAN", "DOUBLE", "FLOAT", "LONG", "INT", "CHAR", "SHORT", "BYTE", 
			"VOID", "NULL", "TIME", "PASSWORD", "STRING", "ANY", "NEVER", "R", "C", 
			"V", "FUNC", "LPAREN", "RPAREN", "LBRACK", "RBRACK", "COMMA", "DOT", 
			"NUM", "COLON", "AT", "GT", "LT", "BITAND", "BITOR", "QUESTION", "ARROW", 
			"COLONCOLON", "WS", "IDENTIFIER", "DECIMAL_LITERAL"
		};
	}
	...
	private TypeContext type(int _p) throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 137779806206L) != 0)) {
					{
					setState(57);
					typeList();
					}
	...
	public static class PrimitiveTypeContext extends ParserRuleContext {
		...
		public TerminalNode SHORT() { return getToken(TypeParser.SHORT, 0); }
		public TerminalNode BYTE() { return getToken(TypeParser.BYTE, 0); }
		...
		public TerminalNode FLOAT() { return getToken(TypeParser.FLOAT, 0); }
