...
public class HttpRequestImplKlassBuilder implements StdKlassBuilder {
    ...
    public Klass build(StdKlassRegistry registry) {
        var klass = KlassBuilder.newBuilder(Id.parse("01b0ee0100"), "HttpRequestImpl", "org.manul.http.HttpRequestImpl")
                .kind(ClassKind.VALUE)
                .source(ClassSource.BUILTIN)
                .tag(740)
                .maintenanceDisabled()
                .build();
        registry.addKlass(org.manul.http.HttpRequestImpl.class, klass);
        klass.setInterfaces(List.of((ClassType) registry.getType(org.manul.api.entity.HttpRequest.class)));
        {
