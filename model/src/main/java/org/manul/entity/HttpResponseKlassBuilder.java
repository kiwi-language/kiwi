...
public class HttpResponseKlassBuilder implements StdKlassBuilder {
    ...
    public Klass build(StdKlassRegistry registry) {
        var klass = KlassBuilder.newBuilder(Id.parse("01fee90100"), "HttpResponse", "org.manul.api.entity.HttpResponse")
                .kind(ClassKind.INTERFACE)
                .source(ClassSource.BUILTIN)
                .tag(447)
                .maintenanceDisabled()
                .build();
        registry.addKlass(org.manul.api.entity.HttpResponse.class, klass);
        {
    ...
    public Class<?> getJavaClass() {
        return org.manul.api.entity.HttpResponse.class;
    }
