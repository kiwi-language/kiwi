...
public class IndexKlassBuilder implements StdKlassBuilder {
    ...
    public Klass build(StdKlassRegistry registry) {
        var klass = KlassBuilder.newBuilder(Id.parse("01f8e90100"), "Index", "org.manul.api.Index")
                ...
                .maintenanceDisabled()
                .build();
        registry.addKlass(org.manul.api.Index.class, klass);
                ...
                .build();
        {
            ...
            method.addParameter(new Parameter(Id.parse("01f8e9010a"), "keyComputer", registry.getParameterizedType(null, java.util.function.Function.class, List.of(registry.getTypeVariable(org.manul.api.Index.class, "V"), registry.getTypeVariable(org.manul.api.Index.class, "K"))), method));
        }
        {
            var method = MethodBuilder.newBuilder(klass, "Index")
            ...
            method.addParameter(new Parameter(Id.parse("01f8e90112"), "keyComputer", registry.getParameterizedType(null, java.util.function.Function.class, List.of(registry.getTypeVariable(org.manul.api.Index.class, "V"), registry.getTypeVariable(org.manul.api.Index.class, "K"))), method));
        }
        {
            var method = MethodBuilder.newBuilder(klass, "query")
                    .id(Id.parse("01f8e9011e"))
                    .returnType(Types.getArrayType(registry.getTypeVariable(org.manul.api.Index.class, "V")))
                    .isNative(true)
                    .nativeFunction((self, args, callContext) -> {
                    ...
                    .build();
            method.addParameter(new Parameter(Id.parse("01f8e90120"), "min", registry.getTypeVariable(org.manul.api.Index.class, "K"), method));
            method.addParameter(new Parameter(Id.parse("01f8e90122"), "max", registry.getTypeVariable(org.manul.api.Index.class, "K"), method));
        }
        {
            var method = MethodBuilder.newBuilder(klass, "count")
                    ...
                    .build();
            method.addParameter(new Parameter(Id.parse("01f8e9011a"), "min", registry.getTypeVariable(org.manul.api.Index.class, "K"), method));
            method.addParameter(new Parameter(Id.parse("01f8e9011c"), "max", registry.getTypeVariable(org.manul.api.Index.class, "K"), method));
        }
        {
            var method = MethodBuilder.newBuilder(klass, "getAll")
                    ...
                    .build();
            method.addParameter(new Parameter(Id.parse("01f8e90116"), "key", registry.getTypeVariable(org.manul.api.Index.class, "K"), method));
        }
        {
            var method = MethodBuilder.newBuilder(klass, "getFirst")
                    .id(Id.parse("01f8e90124"))
                    .returnType(Types.getNullableType(registry.getTypeVariable(org.manul.api.Index.class, "V")))
                    .isNative(true)
                    .nativeFunction((self, args, callContext) -> {
                        var index = getIndex(self);
                        var key = args.getFirst();
                    ...
                    .build();
            method.addParameter(new Parameter(Id.parse("01f8e90126"), "key", registry.getTypeVariable(org.manul.api.Index.class, "K"), method));
        }
        {
            var method = MethodBuilder.newBuilder(klass, "getLast")
                    ...
                    .build();
            method.addParameter(new Parameter(Id.parse("01f8e9012e"), "key", registry.getTypeVariable(org.manul.api.Index.class, "K"), method));
        }
        {
