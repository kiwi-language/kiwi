...
public class HttpResponseImplKlassBuilder implements StdKlassBuilder {
    ...
    public Klass build(StdKlassRegistry registry) {
        var klass = KlassBuilder.newBuilder(Id.parse("019ced0100"), "HttpResponseImpl", "org.manul.http.HttpResponseImpl")
                .source(ClassSource.BUILTIN)
                .tag(766)
                .ephemeral(true)
                .maintenanceDisabled()
                .build();
        registry.addKlass(org.manul.http.HttpResponseImpl.class, klass);
        klass.setInterfaces(List.of((ClassType) registry.getType(org.manul.api.entity.HttpResponse.class)));
        {
        ...
        }
        {
            MethodBuilder.newBuilder(klass, "getCookies")
                    ...
                    .returnType(Types.getArrayType(registry.getType(org.manul.api.entity.HttpCookie.class)))
                    .isNative(true)
                    .nativeFunction((self, args, callContext) -> {
                        var r = (HttpResponseImpl) self;
        ...
        }
        {
            MethodBuilder.newBuilder(klass, "getHeaders")
                    ...
                    .returnType(Types.getArrayType(registry.getType(org.manul.api.entity.HttpHeader.class)))
                    .isNative(true)
                    .nativeFunction((self, args, callContext) -> {
                        var r = (HttpResponseImpl) self;
