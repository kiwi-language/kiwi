...
public class HttpRequestKlassBuilder implements StdKlassBuilder {
    ...
    public Klass build(StdKlassRegistry registry) {
        var klass = KlassBuilder.newBuilder(Id.parse("01fce90100"), "HttpRequest", "org.manul.api.entity.HttpRequest")
                .kind(ClassKind.INTERFACE)
                .source(ClassSource.BUILTIN)
                .tag(446)
                .maintenanceDisabled()
                .build();
        registry.addKlass(org.manul.api.entity.HttpRequest.class, klass);
        {
    ...
    public Class<?> getJavaClass() {
        return org.manul.api.entity.HttpRequest.class;
    }
