...
import org.manul.util.Never;
import org.manul.util.Null;
import org.manul.util.Password;
...
public class StdKlassRegistry {
    ...
    public org.manul.object.type.Type getType(Type javaType) {
        ...
        if (javaType instanceof WildcardType wildcardType) {
            org.manul.object.type.Type lb = NeverType.instance;
            org.manul.object.type.Type ub = Types.getNullableAnyType();
    ...
    public static @javax.annotation.Nullable org.manul.object.type.Type getPrimitiveType(java.lang.reflect.Type javaType) {
    ...
    public org.manul.object.type.Type getParameterizedType(@Nullable ClassType ownerType, Class<?> rawClass, List<org.manul.object.type.Type> typeArgs) {
