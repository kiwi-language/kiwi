...
public class ModelIdentities {
    ...
    private static Type getModelType(Object o) {
        return switch (o) {
            ...
            case Method ignored -> org.manul.flow.Method.class;
            case Constructor<?> ignored -> org.manul.flow.Method.class;
            case Field field -> {
                if (Modifier.isStatic(field.getModifiers()) && field.getType() == IndexDef.class)
                    yield Index.class;
                else
                    yield org.manul.object.type.Field.class;
            }
            case TypeVariable<?> ignored -> org.manul.object.type.TypeVariable.class;
            case Parameter ignored -> org.manul.flow.Parameter.class;
