...
import org.manul.expression.Var;
import org.manul.flow.Error;
import org.manul.flow.*;
...
import static org.manul.util.Utils.*;
...
//        }
    ...
    public int getClassFlags() {
        int flags = 0;
        if(isAbstract)
            flags |= org.manul.entity.KlassFlags.FLAG_ABSTRACT;
        if(struct)
            flags |= org.manul.entity.KlassFlags.FLAG_STRUCT;
        if(searchable)
            flags |= org.manul.entity.KlassFlags.FLAG_SEARCHABLE;
        if(ephemeral)
            flags |= org.manul.entity.KlassFlags.FLAG_EPHEMERAL;
        if(anonymous)
            flags |= org.manul.entity.KlassFlags.FLAG_ANONYMOUS;
        if(templateFlag)
            flags |= org.manul.entity.KlassFlags.FLAG_TEMPLATE;
        return flags;
    }

    public void setClassFlags(int flags) {
        isAbstract = (flags & org.manul.entity.KlassFlags.FLAG_ABSTRACT) != 0;
        struct = (flags & org.manul.entity.KlassFlags.FLAG_STRUCT) != 0;
        searchable = (flags & org.manul.entity.KlassFlags.FLAG_SEARCHABLE) != 0;
        ephemeral = (flags & org.manul.entity.KlassFlags.FLAG_EPHEMERAL) != 0;
        anonymous = (flags & org.manul.entity.KlassFlags.FLAG_ANONYMOUS) != 0;
        templateFlag = (flags & org.manul.entity.KlassFlags.FLAG_TEMPLATE) != 0;
    }
